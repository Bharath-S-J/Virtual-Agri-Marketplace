      ...
      <div class="flex">
         <div class="inputBox1">
          ...
          <span>Old Password :</span>
            <input type="password"  name="old_password" id="old_password" class="box">
            <span>New Password :</span>
            <input type="password"  name="new_password" id="new_password" class="box">
            <span>Conform New Password :</span>
            <input type="password"  name="conform_password" id="conform_password" class="box">
            <br><br><br>
            <button style='background-color: #00B5E2;  border: none; color: white; padding: 12px 24px;text-align: center;
              ...
              type="submit" id='update_password' name="update_password" id = "update_password">Reset Password</button>
              <br> 
